...
public class SWAServiceConsumerTest {

    // this is the mock for evaluator service
    @Mock
    SWAServiceInterface evaluatorServiceMock;
    ...
    @Test
    public void testSWAServiceConsumerWithMock() throws Exception {

        // wrap the evaluator mock in proxy
        SWAServiceInterface serviceInterface = ServiceProxy.newInstance(evaluatorServiceMock);
        ...
        SWAServiceConsumer logicalOperator = new SWAServiceConsumer();
        try {
